  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="予約詳細"
        className={
          'fixed top-0 right-0 z-50 flex h-full w-[480px] flex-col overflow-hidden border-l border-ink-100 bg-surface-0 shadow-2xl transition-transform duration-300 ease-out ' +
