...
const TEMPLATES: Array<{ id: string; name: string; content: string; category: string }> = [
  { id: '55555555-5555-5555-5555-555555555501', name: '来店確認',         content: 'ご予約日時のご確認です。\n\n{予約日時}\n{メニュー}\n\nご来店をお待ちしております。', category: '予約確認' },
  { id: '55555555-5555-5555-5555-555555555502', name: '来店前リマインダ', content: '明日 {予約時刻} のご予約です。\nお気をつけてお越しください。', category: 'リマインダ' },
  { id: '55555555-5555-5555-5555-555555555503', name: '来店お礼',         content: '本日はご来店ありがとうございました。\n仕上がりはいかがでしょうか？\n次回もお待ちしております。', category: 'フォロー' },
  { id: '55555555-5555-5555-5555-555555555504', name: 'リピート促進',     content: '前回ご来店から {経過日数} 経ちました。\n次回のご予約はいかがでしょうか？\nお気軽にメッセージください。', category: 'リピート' },
  { id: '55555555-5555-5555-5555-555555555505', name: '季節キャンペーン', content: '春の新メニューが登場しました！\n5/31 までのご予約で 10% OFF クーポンプレゼント中。', category: 'キャンペーン' },
];
